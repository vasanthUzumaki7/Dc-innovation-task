    ...
    <div className='policy-input-container'>
      ...
      <div>
        <form onSubmit={firstSubmit}>
          ...
          <p>From Date</p>
          <input type="date" required onChange={formChange} name='fromDate' value={policyForm.fromDate ? formatDateForInput(policyForm.fromDate) : ''} />
          <p>To Date</p>
          <input type="date" required onChange={formChange} name='toDate' value={policyForm.toDate ? formatDateForInput(policyForm.toDate) : ''} />
          <p>Amount</p>
